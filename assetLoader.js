function loadAssets() {
    loadSpriteAtlas('./assets/characters.png', {
        ...
        // Remove a definição do cogumelo
    ...
    // Carrega sua própria imagem e atribui a uma chave
    loadSprite('player-custom', './assets/vadim.png');

    // Carrega a imagem do fundo da batalha

let dialogueUpdateHandler; // Variável global para armazenar o manipulador de atualização do diálogo
...
function setWorld(worldState) {
    ...
    player.onCollide('npc', () => {
        ...
        dialogueUpdateHandler = onUpdate(() => {
            if (isKeyDown('space')) {
                destroy(dialogueBox)
                player.isInDialogue = false
                clearInterval(dialogueUpdateHandler); // Correção: Usar clearInterval em vez de clearHandler
            } 
        })
    })
